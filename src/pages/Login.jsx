    ...
    return (
     ...
     data-aos-duration="1000">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        ...
        <button className="block w-full p-3 text-center rounded-sm bg-green-400 border-none text-white">
          Login
        </button>
      </form>
      ...
      <div className="flex justify-center space-x-4">
        <button  onClick={handlegoogle} aria-label="Log in with Google" className="px-3 flex items-center border-2 border-solid border-gray-200 cursor-pointer rounded-sm" data-aos="fade-up"
     data-aos-duration="2000">
        ...
        <button onClick={handlegithub} aria-label="Log in with GitHub" className="px-3 flex items-center rounded-sm  border-2 border-solid border-gray-200  cursor-pointer" data-aos="fade-up"
