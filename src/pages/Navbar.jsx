...
const Navbar = () => {
  ...
  return (
    <div className="navbar  mx-auto px-4 fixed bg-white dark:bg-transparent opacity-90  z-50  top-0 shadow-sm">
      <div className="max-w-[1440px] mx-auto w-full justify-between">
        <div className="navbar-start flex items-center ">
          ...
          ${open ? "-right-36" : "right-24"}
          mt-3 z-[2] p-2 shadow bg-[#F2F6F7] h-lvh w-60 pl-12`}
              >
                {NavigateItem}
                <div>
                  {user && (
